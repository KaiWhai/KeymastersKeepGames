...
class TheBindingOfIsaacRebirthGame(Game):
    ...
    def game_objective_templates(self) -> List[GameObjectiveTemplate]:
        ...
        if self.has_afterbirth:
            templates.extend([
                GameObjectiveTemplate(
                    label="Defeat Ultra Greed as CHARACTER while holding at least COUNT coins",
                    data={
                        "CHARACTER": (self.characters, 1),
                        "COUNT": (self.coin_range, 1),
                    },
                ...
                GameObjectiveTemplate(
                    ...
                    data={
                        "BOSS": (self.bosses_no_hush_no_mother, 1),
                        "CHARACTER": (self.characters, 1),
                    },
                    is_time_consuming=False,
                    is_difficult=False,
            ...
            if self.has_afterbirth_plus:
                templates.extend([
                    GameObjectiveTemplate(
                        label="Defeat Ultra Greedier as CHARACTER while holding at least COUNT coins",
                        data={
                            "CHARACTER": (self.characters, 1),
                            "COUNT": (self.coin_range, 1),
                        },
    ...
    def bosses_no_hush_no_mother(self) -> List[str]:
        bosses: List[str] = self.bosses_base[:]
