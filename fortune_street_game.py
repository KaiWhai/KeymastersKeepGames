...
class FortuneStreetArchipelagoOptions:
    ...
    fortune_street_custom_boards: FortuneStreetCustomBoards
...
class FortuneStreetGame(Game):
    ...
    def game_objective_templates(self) -> List[GameObjectiveTemplate]:
        return [
            ...
            GameObjectiveTemplate(
                label="Dominate a district on BOARD",
                data={
                    "BOARD": (self.boards, 1),
                },
                is_time_consuming=False,
            ...
            GameObjectiveTemplate(
                label="Get a Venture Card bingo on BOARD",
                data={
                    "BOARD": (self.boards, 1),
                },
                is_time_consuming=False,
            ...
            GameObjectiveTemplate(
                label="Receive gold from OPPONENT",
                data={
            ...
            GameObjectiveTemplate(
                label="Achieve world domination on BOARD",
                data={
                    "BOARD": (self.boards, 1),
                },
    ...
    @property
    def custom_boards(self) -> Set[str]:
        return self.archipelago_options.fortune_street_custom_boards.value
    ...
    def boards(self) -> List[str]:
        ...
        return sorted(boards + list(self.custom_boards))
...
class FortuneStreetCustomBoards(OptionSet):
    """
    Indicates which Fortune Street custom boards the player would like to include. 
    """

    display_name = "Fortune Street Custom Boards"
    default = list()
