...
@dataclass
class MinecraftRandomSpeedrunsArchipelagoOptions:
    pass


class MinecraftRandomSpeedruns(Game):
    name = "Minecraft Random Item Speedruns"
    ...
    options_cls = MinecraftRandomSpeedrunsArchipelagoOptions

    def game_objective_templates(self) -> List[GameObjectiveTemplate]:
        return [
            GameObjectiveTemplate(
                label="From a fresh world obtain the following: ITEM",
                data={
                    "ITEM": (self.items, 1),
                },
            ...
            GameObjectiveTemplate(
                label="From a fresh world obtain the following: ITEMS",
                data={
                    "ITEMS": (self.items, 2),
                },
                is_time_consuming=False,
